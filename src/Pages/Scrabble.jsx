...
const Scrabble = () => {
    ...
    return (
        ...
        <div className="scrabble-tile-container">
            <span className="tile" id="tw">TRIPPLE WORD SCORE</span>
            <span className="tile"></span>
            <span className="tile"></span>
            <span className="tile" id="dl">DOUBLE LETTER SCORE</span>
            <span className="tile"></span>
            <span className="tile"></span>
            <span className="tile"></span>
            <span className="tile" id="tw">TRIPPLE WORD SCORE</span>
            ...
            {/* End of First Row */}
            <span className="tile"></span>
            <span className="tile" id="dw">DOUBLE WORD SCORE</span>
            <span className="tile"></span>
            <span className="tile"></span>
            <span className="tile"></span>
            <span className="tile" id="tl">TRIPPLE LETTER SCORE</span>
            <span className="tile"></span>
            <span className="tile"></span>
            <span className="tile"></span>
            <span className="tile" id="tl">TRIPPLE LETTER SCORE</span>
            ...
            <span className="tile"></span>
            <span className="tile"></span>
            <span className="tile" id="center"><img src={Star} className="star"/></span>
            <span className="tile"></span>
            <span className="tile"></span>
            <span className="tile"></span>
            <span className="tile" id="dl">DOUBLE LETTER SCORE</span>
